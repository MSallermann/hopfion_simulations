...
# Settings
cm                = 1/2.54
FIG_WIDTH         = 17.5 * cm  * 2/3# Full DIN A4 width
FIG_HEIGHT        = FIG_WIDTH / 0.90 # Golden ratio

NCOLS = 2
NROWS = 3
HORIZONTAL_MARGINS = [0.05, 0.0]
VERTICAL_MARGINS  = [0.075, 0.025]
WSPACE            = 0.05
HSPACE            = 0.05
WIDTH_RATIOS      = None
HEIGHT_RATIOS     = None
...
# Criterion gridspec
gs0 = GridSpecFromSubplotSpec(12, 9, subplot_spec=gs[0:3,0], hspace=0.0, wspace=0.0)
...
a = fig.add_axes(gs0[8:12,5:9].get_position(fig), label="sdd")
...
fig.savefig("plot1_v2.png", dpi=300)